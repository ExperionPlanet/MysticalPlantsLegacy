...
public class MysticalPlantBlockWithEntity extends BlockWithEntity {
    ...
    public MysticalPlantBlockWithEntity(Settings settings) {
        super(settings);
    }
    ...
    protected VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return PLANT_SHAPE.offset(vec3d.x, vec3d.y, vec3d.z);
    }
