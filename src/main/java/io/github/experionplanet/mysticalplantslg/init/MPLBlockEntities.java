...
import io.github.experionplanet.mysticalplantslg.blocks.entity.custom.*;
...
public class MPLBlockEntities {
    ...
    public static final BlockEntityType<SoulBellBlockEntity> SOUL_BELL = register("soul_bell", SoulBellBlockEntity::new, MPLBlocks.SOUL_BELL);
