...
public class MPLParticles {
    ...
    public static final SimpleParticleType ROOTED_SPORE = FabricParticleTypes.simple();
    public static final SimpleParticleType PERMAFROST_SPORE = FabricParticleTypes.simple();
    public static final SimpleParticleType POSSESSION_SPORE = FabricParticleTypes.simple();
    ...
    public static final SimpleParticleType VOID_MIST = FabricParticleTypes.simple();
    public static final SimpleParticleType ROOTED_AMBIENT = FabricParticleTypes.simple();
    ...
    public static void bootstrap() {
        ...
        Registry.register(Registries.PARTICLE_TYPE, MysticalUtils.newId("rooted_spore"), ROOTED_SPORE);
        Registry.register(Registries.PARTICLE_TYPE, MysticalUtils.newId("permafrost_spore"), PERMAFROST_SPORE);
        Registry.register(Registries.PARTICLE_TYPE, MysticalUtils.newId("possession_spore"), POSSESSION_SPORE);
        ...
        Registry.register(Registries.PARTICLE_TYPE, MysticalUtils.newId("void_mist"), VOID_MIST);
        Registry.register(Registries.PARTICLE_TYPE, MysticalUtils.newId("rooted_ambient"), ROOTED_AMBIENT);
