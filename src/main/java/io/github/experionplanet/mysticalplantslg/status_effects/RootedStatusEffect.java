...
public class RootedStatusEffect extends StatusEffect {
    public RootedStatusEffect() {
        super(StatusEffectCategory.HARMFUL,  ColorHelper.Argb.getArgb(152, 116, 8));
    }
    ...
    public boolean applyUpdateEffect(LivingEntity entity, int amplifier) {
        ...
        if (!world.isClient()) {
            ...
            ((ServerWorld) world).spawnParticles(MPLParticles.ROOTED_AMBIENT, v.getX(), v.getY(), v.getZ(), 1, box.getLengthX()/2d, box.getLengthY()/2d, box.getLengthZ()/2d, 0);
