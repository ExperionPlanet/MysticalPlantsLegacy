...
public class MPLStatusEffects {
    ...
    public static final RegistryEntry<StatusEffect> VOID = Registry.registerReference(Registries.STATUS_EFFECT, ExperionUtils.newId("void"), new BasicStatusEffect(StatusEffectCategory.HARMFUL, ColorHelper.Argb.getArgb(125, 23, 159)));
    public static final RegistryEntry<StatusEffect> ROOTED = Registry.registerReference(Registries.STATUS_EFFECT, ExperionUtils.newId("rooted"), new BasicStatusEffect(StatusEffectCategory.HARMFUL, ColorHelper.Argb.getArgb(152, 116, 8)));
