...
public class MPLBlocks {
    ...
    public static final Block GLACIER_PASSION_FLOWER = register("glacier_passion_flower", GlacierPassionFlowerBlock::new, AbstractBlock.Settings.create().nonOpaque().sounds(BlockSoundGroup.MOSS_CARPET).noCollision(), true);
    public static final Block FROST_UMBRELLA_FLOWER = register("frost_umbrella_flower", FrostUmbrellaFlowerBlock::new, AbstractBlock.Settings.create().sounds(BlockSoundGroup.WET_GRASS).nonOpaque().noCollision(), true);

    // SWAMP
    public static final Block DISGUISE_ORCHID = register("disguise_orchid", DisguiseOrchidBlock::new, AbstractBlock.Settings.create().noCollision().sounds(BlockSoundGroup.GRASS).nonOpaque(), true);
