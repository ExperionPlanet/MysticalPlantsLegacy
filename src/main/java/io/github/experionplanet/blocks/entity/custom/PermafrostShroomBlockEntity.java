...
public class PermafrostShroomBlockEntity extends LastTickedBlockEntity {
    public static final int T_STEPPED = 0;

    public PermafrostShroomBlockEntity(BlockPos pos, BlockState state) {
        super(MPLBlockEntities.PERMAFROST_SHROOM, pos, state);
        addTick();
    }
